...
export default function ContactSection() {
   return (
      <SectionWrapper id="contact" bg="gray" spacing="major" className="relative overflow-hidden border-t border-gray-100 scroll-mt-24">
                  ...
                  <dl className="space-y-6 text-base leading-7 text-gray-600">
                     ...
                     <div className="flex gap-x-4 items-center">
                        ...
                        <dd>
                           ...
                           <a className="hover:text-blue-600 transition-colors" href="https://contentshield.com" target="_blank" rel="noopener noreferrer">safeshield.com</a>
                        </dd>
                     </div>
                  </dl>
               </div>
